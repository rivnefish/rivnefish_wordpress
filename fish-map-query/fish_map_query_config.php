...
$password = "torOvrewm%";
$charset = "utf8";
$username_rw = "rivnefish_word";
$password_rw = "dfjAshj23hcn4";
// dublicates
...
define('EXT_DB_USER_RW', 'rivnefish_word');     // Your MySQL read/write username
define('EXT_DB_PASSWORD_RW', 'dfjAshj23hcn4');     // read/write password
